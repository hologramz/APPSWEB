...
<nav class="navbar navbar-expand beta-menu navbar-dropdown align-items-center navbar-fixed-top navbar-toggleable-sm">
    ...
    <div class="menu-logo">
        <div class="navbar-brand">
            ...
            <span class="navbar-caption-wrap"><a class="navbar-caption text-white display-4" href="/ultimoiswear/index.php">
            ...
            <!--<a class="nav-link link text-white display-4" href="/ultimoiswear/php/login.php" aria-expanded="false">-->
              ...
              if(!isset($_SESSION['sess_user'])){
                ...
                if($admin == 'admin@swdroids.com'){
                  echo "<li class='nav-item active'>";
                  echo "<a class='nav-link link text-white display-4' href='./admin.php' aria-expanded='false'>MODIFY</a>";
                  echo "</li>";
                }
              }
